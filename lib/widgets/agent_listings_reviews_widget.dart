        ...
        children: [
          Row(
            ...
            children: [
              ...
              // release build on Android). Use an Image.network with an
              // errorBuilder inside a ClipOval so a missing/undecodable avatar
              // falls back to the person icon instead of crashing.
              SizedBox(
                width: 40,
                height: 40,
                child: ClipOval(
