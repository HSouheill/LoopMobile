...
class RealEstateSignupPage3 extends StatefulWidget {
  const RealEstateSignupPage3({super.key});

  @override
  State<RealEstateSignupPage3> createState() => _RealEstateSignupPage3State();
}

class _RealEstateSignupPage3State extends State<RealEstateSignupPage3> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    Text(
                      'Please upload the required documents to complete your agent registration',
                      style: TextStyle(
                        fontSize: 14,
                        color: Colors.grey[600],
                      ),
