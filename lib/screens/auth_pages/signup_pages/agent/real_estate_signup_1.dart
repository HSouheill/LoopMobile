...
class RealEstateSignupPage1 extends StatefulWidget {
  ...
  @override
  State<RealEstateSignupPage1> createState() => _RealEstateSignupPage1State();
}

class _RealEstateSignupPage1State extends State<RealEstateSignupPage1> {
  ...
  void _next() {
    if (_formKey.currentState!.validate()) {
      Navigator.pushNamed(context, '/realEstateSignup2', arguments: {
