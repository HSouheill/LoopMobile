...
class RealEstateCompanySignupPage3 extends StatefulWidget {
  ...
  @override
  State<RealEstateCompanySignupPage3> createState() => _RealEstateCompanySignupPage3State();
}

class _RealEstateCompanySignupPage3State extends State<RealEstateCompanySignupPage3> {
  ...
  void _next() {
    if (_formKey.currentState!.validate()) {
      Navigator.pushNamed(context, '/realEstateCompanySignup4', arguments: {
